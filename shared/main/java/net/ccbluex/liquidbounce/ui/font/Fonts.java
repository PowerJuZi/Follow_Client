...
public class Fonts extends MinecraftInstance {
    ...
    @FontDetails(fontName = "Roboto Medium", fontSize = 65)
    public static IFontRenderer font65;
    ...
    public static void loadFonts() {
        ...
        downloadFonts();
        font65 = classProvider.wrapFontRenderer(new GameFontRenderer(getFont("Roboto-Medium.ttf", 65)));
